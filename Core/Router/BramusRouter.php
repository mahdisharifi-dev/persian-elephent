...
class BramusRouter
{
    ...
    private function handle($routes, $quitAfterRun = false)
    {
        ...
        foreach ($routes as $route) {
            ...
            // Mahdi Sharifi added this line.
            $mainPattern = $route['pattern'];
            ...
            if (preg_match_all('#^' . $route['pattern'] . '$#', $uri, $matches, PREG_OFFSET_CAPTURE)) {
                ...
                // Mahdi Sharifi added this line.
                $this->insertParamsToGetSuperGlobal($mainPattern, $params);
    ...
    // Mahdi Sharifi costume method
    public function insertParamsToGetSuperGlobal (string $pattern, array $params) : void {
        preg_match_all("/{([^}]+)}/", $pattern, $keys);
        for($i = 0; $i < count($keys[1]); $i++) {
            $_GET[$keys[1][$i]] = $params[$i];
        }
    }
